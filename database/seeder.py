...
def seed_organizations(session: Session):
    if not session.query(Organization).first():
        organizations = [
            ...
            Organization(name='Org4', ragione_sociale='RS4', description='Desc4', partita_iva='12345678904', address='Address4', city='City4', cap='00004', telephone='1234567893', email='org4@example.com', type='carrier', status= 'active'),
        ]
